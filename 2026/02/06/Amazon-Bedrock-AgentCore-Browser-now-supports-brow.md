...
- **Amazon Bedrock AgentCore updates with enterprise features**
...
- ブラウザプロファイルはクッキーとローカルストレージを含むブラウザデータを永続化し、複数セッション間で再利用します。
...
- Amazon Bedrock AgentCore Browser now supports browser profiles について紹介しました
- 詳細は元記事をご確認ください
...
- [元記事を開く](https://aws.amazon.com/about-aws/whats-new/2026/02/amazon-bedrock-agentcore-browser-profiles)
